...
1. **Ответьте и поздоровайтесь**, затем выслушайте краткий отчёт.
2. **Общайтесь обычным образом**: «Что уже готово?», «Какие проблемы остались?», «Почему ты это изменил?», «Чем отличаются эти варианты?» Можно попросить повторить или объяснить проще. Сначала обсудите вопрос; обсуждение само по себе не означает поручение изменить проект.
3. **Чтобы поручить работу, скажите:**

   > Следующая задача: XXXXX.

   Для разговора на китайском: **«下一步的任务是：XXXXX。»** Например: «Следующая задача: проверь все ссылки на главной странице, исправь неработающие и сообщи, что изменилось». Укажите действие, объём работы и ожидаемый результат.
4. **Дождитесь подтверждения доставки.** После этого можно завершить звонок и ждать отчёта о выполнении. Если начало выполнения не подтверждено, проверьте исходную задачу: доставка ещё не означает, что работа началась.

Один звонок передаёт одну команду на выполнение. Дополнения, изменения и отмену после отправки делайте в исходной задаче Codex. Можно просто задать вопросы и завершить разговор без нового поручения.

Перед первым пробным звонком Codex объяснит эти шаги и спросит разрешение на вызов.
...
Также доступен пункт **3. Выбрать другую речевую модель самостоятельно**: сообщите Codex название или ID для проверки совместимости до подключения.
